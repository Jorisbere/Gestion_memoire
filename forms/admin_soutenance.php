...
<head>
  ...
  <style>
    ...
    @media (min-width: 901px) {
      .gm-main { padding-left: 280px; }
    }
    @media (max-width: 900px) {
      .gm-main { padding-top: 80px; }
    }
    ...
    select { padding: 8px; border-radius: 6px; border: 1px solid #ccc; font-size: 15px; }
    ...
    .btn-success { background-color: #28a745; color: white; margin: 0 5px;margin-bottom: 5px;}

    .btn-danger { background-color: #dc3545; color: white; margin: 0 5px;margin-bottom: 5px;}

    .btn:hover { opacity: 0.8; }

    .badge { padding: 5px 10px; border-radius: 12px; font-size: 0.9em; color: white; }
    ...
    <script>
      ...
      document.querySelectorAll('.validation-form').forEach(form => {
        form.addEventListener('submit', function(e) {
          ...
          fetch('valider_soutenance.php', { method: 'POST', body: formData })
          .then(r => r.json())
          .then(data => {
            if (data.success) {
